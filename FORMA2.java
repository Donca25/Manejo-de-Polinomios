...
private int DU, VF2[];
    ...
    public void Suma1a3(FORMA3 Pol3, FORMA3 Pol1) {
        Nodo P = Pol3.punta;
        int i = 1, j = 1, Exp = 0;

        while (P != null || i <= Pol1.getDU()) {
            if (P != null && i <= Pol1.getDU()) {
                if (i <= Pol1.getDU()) {
                    Exp = Pol1.getDU() - i;
                }
                if (Pol1.getVF1(i) == 0){
